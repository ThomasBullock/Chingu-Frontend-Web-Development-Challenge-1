...
(function (global) {
	...
	// Off Canvas	
	);var offCanvasMenuBtn = document.querySelector('.navbar__menu-toggle');
	var offCanvasMenu = document.querySelector('.offcanvas-nav');
	var offCanvasFadeScreen = document.querySelector('.offcanvas-fade-screen');
	var menuIcon = document.querySelector('.navbar__menu-icon');

	offCanvasMenuBtn.addEventListener('click', function (e) {
	...
	// Gallery
	);var galleryItems = Array.from(document.querySelectorAll('.gallery__img'));
	galleryItems.forEach(function (picture) {
		picture.addEventListener('mouseover', function (e) {
			var caption = e.target.nextElementSibling;
	...
	// Features
	);var processNumbers = Array.from(document.querySelectorAll('.features__icon'));
	var processList = Array.from(document.querySelectorAll('.features__list-item'));

	processNumbers.forEach(function (item) {
